<template>
  ...
  >
    ...
    <div style="padding: 10px 0; font-size: 16px; font-weight: bolder">审批人员</div>
...
const selectCheckWay = (val) => {
  for (let item of checkWayData.value) {
    if (item.CheckWay === val) {
      FlowInfo.value.CheckWayName = item.CheckWayName
      break
    }
  }
}
