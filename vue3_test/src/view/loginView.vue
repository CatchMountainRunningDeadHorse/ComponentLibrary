    ...
    <section>
        ...
        <div class="login">
            ...
            <div class="inputBox">
                ...
                <el-icon @click="showPwd" class="see"><View /></el-icon>     
                <el-icon @click="showPwd" class="no-see"><Hide /></el-icon>
            </div> -->
            <el-form
                ref="ruleFormRef"
            ...
            >
                ...
                <el-form-item class="inputBox">
                    <el-button class="btn" type="primary" @click="login(ruleFormRef)">Login</el-button>
                </el-form-item>
            </el-form>
            <div class="group">
                <a >Foget Password</a>
    ...
    const login = (e) => {
        e.validate(async (valid)=>{
            if(valid){
                ...
                // const {data} = await postData('login',ruleForm)
                // console.log('KJnsdkjbvdkjfnk',data);
                // if(data.code === 0){
                //     localStorage.setItem('isLogin',true)
                //     router.push('/')
                    //对服务端进行websocket的连接
