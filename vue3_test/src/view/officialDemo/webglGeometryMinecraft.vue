...
const threeRef = ref()
let stats,camera, controls, scene,animateID, 
renderer,model,mixer,walkAction,actions,
settings,walkWeight,singleStepMode = false;
...
function init() {
    ...
    camera.position.y = getY( worldHalfWidth, worldHalfDepth ) * 100 + 2000;
